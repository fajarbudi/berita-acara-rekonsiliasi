...
@section('content')
    ...
    <div class="content">
        ...
        <div class="card-bar">
            <div class="card-top">
                <div class="ms-auto d-flex gap-2">
                    <a href="{{ route('belanja.view') }}" class="btn btn-sm btn-warning">
    ...
    <div class="modal fade" id="mdlFilter" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="formFilter" novalidate method="GET" action="{{ route('belanja.view') }}">
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label req">Nama Belanja</label>
                                <input type="text" class="form-control form-control-sm"
                                    placeholder="Masukkan nama jenis belanja" required name="belanja_nama"
                                    id="f_belanja_nama">
                            </div>
                            <div class="col-md-6">
