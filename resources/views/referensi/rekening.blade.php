...
@section('content')
    ...
    <div class="content">
        ...
        <div class="card-bar">
            <div class="card-top">
                <div class="ms-auto d-flex gap-2">
                    <a href="{{ route('rekening.view') }}" class="btn btn-sm btn-warning">
                ...
                <table class="grid" id="tbl">
                    <thead>
                        <tr>
                            ...
                            <th data-col="0">Nama Rekening</th>
                            <th data-col="1">Kode Rekening</th>
                            <th data-col="2">Uraian</th>
                            <th style="width:120px">Aksi</th>
                        </tr>
                    </thead>
                    <tbody id="tbody">
                        @foreach ($rekenings as $index => $item)
                            <tr>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="formBaru" novalidate method="POST" action="{{ route('rekening.simpan') }}">
                    ...
                    <div class="modal-body">
                        <div class="sec-title">Identitas Rekening</div>
                        <div class="row g-3">
                            <div class="col-md-6">
    ...
    <div class="modal fade" id="mdlFilter" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="formFilter" novalidate method="GET" action="{{ route('rekening.view') }}">
                    <div class="modal-body">
