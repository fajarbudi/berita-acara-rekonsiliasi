...
@section('content')
        ...
        <div class="card-bar">
            ...
            <div class="table-scroll">
                <table class="grid" id="tbl">
                    <thead>
                        <tr>
                            ...
                            <th data-col="0">Nama mekanisme</th>
                            <th data-col="2">Uraian</th>
                            <th style="width:120px">Aksi</th>
                        </tr>
                    </thead>
                    <tbody id="tbody">
                        @foreach ($mekanismes as $item)
                            <tr>
                ...
                <div class="empty d-none" id="kosong">
                    ...
                    Tidak ada mekanisme yang cocok dengan filter.<br>
            ...
            <div class="table-foot">
                <span>Menampilkan <b id="infoTampil">0</b> dari <b id="infoTotal">0</b> mekanisme</span>
                <nav class="ms-auto">
    ...
    <div class="modal" id="mdlHapus" tabindex="1">
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <form id="frmHapus" method="POST" action="{{ route('mekanisme.delete') }}">
                @csrf
    ...
    <div class="modal fade" id="mdlBaru" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="formBaru" novalidate method="POST" action="{{ route('mekanisme.simpan') }}">
                    @csrf
                    <input type="hidden" name="mekanisme_id" id="mekanisme_id">
                    <div class="modal-body">
                        <div class="sec-title">Identitas Dokumen</div>
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label req">Nama mekanisme</label>
                                <input type="text" class="form-control form-control-sm"
                                    placeholder="Masukkan nama mekanisme" required name="mekanisme_nama"
                                    id="mekanisme_nama">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label req">Uraian</label>
                                <textarea class="form-control form-control-sm" placeholder="Masukkan uraian" required name="mekanisme_uraian"
                                    id="mekanisme_uraian"></textarea>
                            </div>
                        </div>
...
@push('script')
    <script>
        ...
        function bukaHapus(data) {
            document.getElementById('hapusTarget').value = data.mekanisme_id;
            document.getElementById('hapusTeks').innerHTML = `Data <b>${data.mekanisme_nama}</b> akan dihapus.`;
